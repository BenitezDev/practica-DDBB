...
public class Main {
	...
	public static void main (String[] args) {
		...
		do {
			...
			System.out.println("  4) Obtener la valoraci�n media de un g�nero.");
			System.out.println("  5) Poner foto de perfil.");
			System.out.println("  0) Salir de la aplicaci�n.");
			
			System.out.println();
			// Extras:
			System.out.println("  6) Conectar con la ddbb.");
			System.out.println("  7) Desconectar con la ddbb.");
			System.out.println("  8) Crear tabla capitulos.");
			...
			case '4':
				...
				System.out.println("La valoraci�n media del género " + genero + " es de " + valoracion + ".");
				break;
			case '5':
